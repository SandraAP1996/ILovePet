$(function() {
    ...
    $.ajax({
        ...
        success: function(eventos){
            ...
            if($("div.eventoCards .row").children().length < 1){
                $('div.eventoCards .row').append('<div class="col-sm-6 align-self-center"><h1>En estos momentos no hay ningún evento próximo</h1></div><div class="col-sm-6 align-self-center"><img class="img-fluid" src="/img/web/pagina/eventos-proximos.jpg"></div> ');
            }
        }
    });
